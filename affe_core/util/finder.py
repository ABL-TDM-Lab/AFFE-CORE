...
class Finder(ABC):
    @final
    def find_first_in(self, target_dir: PathLike) -> Optional[str]:
    ...
    @final
    def find_all_in(self, target_dir: PathLike) -> List[str]:
        paths = []
...
class PatternFinder(Finder):
    def __init__(self, *, init: str = "", ext: str = ""):
        self._init = init
        self._ext = ext

    def _match(self, file: str) -> bool:
